...
CAV*********************************************************************
      if(y23D.gt.ycutD .or. Cpar.gt.Ccut ) then
C      write(*,*)'--->'
C      write(*,*)EEC
      do i=1,15
...
*
      ...
      subroutine outfiles
      implicit real*8(a-h,o-z)
      character*22 fnames(1:200),fname
      common/intech/iaver,imom,idist,iang,idebug
      common/outfile/fname

      fnames(11) = fname(1:15)//'T1a'
      fnames(12) = fname(1:15)//'T1b'
      fnames(13) = fname(1:15)//'T1c'
      fnames(14) = fname(1:15)//'T1d'
      fnames(15) = fname(1:15)//'T2a'
      fnames(16) = fname(1:15)//'T2b'
      fnames(17) = fname(1:15)//'T2c'
      fnames(18) = fname(1:15)//'T2d'
      
      fnames(21) = fname(1:15)//'C1a'
      fnames(22) = fname(1:15)//'C1b'
      fnames(23) = fname(1:15)//'C1c'
      fnames(24) = fname(1:15)//'C1d'
      fnames(25) = fname(1:15)//'C2a'
      fnames(26) = fname(1:15)//'C2b'
      fnames(27) = fname(1:15)//'C2c'
      fnames(28) = fname(1:15)//'C2d'
      
      fnames(31) = fname(1:15)//'M1a'
      fnames(32) = fname(1:15)//'M1b'
      fnames(33) = fname(1:15)//'M1c'
      fnames(34) = fname(1:15)//'M1d'
      fnames(35) = fname(1:15)//'M2a'
      fnames(36) = fname(1:15)//'M2b'
      fnames(37) = fname(1:15)//'M2c'
      fnames(38) = fname(1:15)//'M2d'
      
      fnames(41) = fname(1:15)//'W1a'
      fnames(42) = fname(1:15)//'W1b'
      fnames(43) = fname(1:15)//'W1c'
      fnames(44) = fname(1:15)//'W1d'
      fnames(45) = fname(1:15)//'W2a'
      fnames(46) = fname(1:15)//'W2b'
      fnames(47) = fname(1:15)//'W2c'
      fnames(48) = fname(1:15)//'W2d'
      
      fnames(51) = fname(1:15)//'B1a'
      fnames(52) = fname(1:15)//'B1b'
      fnames(53) = fname(1:15)//'B1c'
      fnames(54) = fname(1:15)//'B1d'
      fnames(55) = fname(1:15)//'B2a'
      fnames(56) = fname(1:15)//'B2b'
      fnames(57) = fname(1:15)//'B2c'
      fnames(58) = fname(1:15)//'B2d'
      
      fnames(61) = fname(1:15)//'Y3a'
      fnames(62) = fname(1:15)//'Y3b'
      fnames(63) = fname(1:15)//'Y3c'
      fnames(64) = fname(1:15)//'Y4a'
      fnames(65) = fname(1:15)//'Y4b'
      fnames(66) = fname(1:15)//'Y4c'
      fnames(67) = fname(1:15)//'Y5a'
      fnames(68) = fname(1:15)//'Y5b'
      fnames(69) = fname(1:15)//'Y5c'
      
      fnames(71) = fname(1:15)//'S3a'
      fnames(72) = fname(1:15)//'S3b'
      fnames(73) = fname(1:15)//'S3c'
      fnames(74) = fname(1:15)//'S4a'
      fnames(75) = fname(1:15)//'S4b'
      fnames(76) = fname(1:15)//'S4c'
      fnames(77) = fname(1:15)//'S5a'
      fnames(78) = fname(1:15)//'S5b'
      fnames(79) = fname(1:15)//'S5c'
      
      fnames(81) = fname(1:15)//'TLa'
      fnames(82) = fname(1:15)//'TLb'
      fnames(83) = fname(1:15)//'TLc'
      fnames(84) = fname(1:15)//'CLa'
      fnames(85) = fname(1:15)//'CLb'
      fnames(86) = fname(1:15)//'CLc'
      fnames(87) = fname(1:15)//'BLa'
      fnames(88) = fname(1:15)//'BLb'
      fnames(89) = fname(1:15)//'BLc'
      fnames(90) = fname(1:15)//'WLa'
      fnames(91) = fname(1:15)//'WLb'
      fnames(92) = fname(1:15)//'WLc'
      fnames(93) = fname(1:15)//'MLa'
      fnames(94) = fname(1:15)//'MLb'
      fnames(95) = fname(1:15)//'MLc'
CAV*********************************************************************
      fnames(96) = fname(1:15)//'ELa'
      fnames(97) = fname(1:15)//'ELb'
      fnames(98) = fname(1:15)//'ELc'
CAV*********************************************************************
